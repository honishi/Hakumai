...
internal enum Asset {
  ...
  internal static let campaignBlack = ImageAsset(name: "campaign_black")
  internal static let chatBlack = ImageAsset(name: "chat_black")
  ...
  internal static let paidBlack = ImageAsset(name: "paid_black")
  ...
  internal static let questionAnswerBlack = ImageAsset(name: "question_answer_black")
  internal static let recordVoiceOverBlack = ImageAsset(name: "record_voice_over_black")
